...
SECTIONS: list[tuple[str, list[str]]] = [
    ...
    ("# PART 3 — Question 5\n", ["part3/q5_coordination.md"]),
    ("# PART 3 — Question 6\n", ["part3/q6_capability.md"]),
    ("# ANNEXES\n\nExcluded from the Q6 page limit, as the question permits.\n",
     [
         "part3/annex_a_competency_framework.md",
         "part3/session_90min/facilitator_guide.md",
         "part3/session_90min/participant_brief.md",
         "part3/session_90min/model_answer.md",
         "part3/annex_c_assessment_instrument.md",
         "part3/annex_d_dataset_spec.md",
         "part3/annex_e_session_plan.md",
     ]),
]
